...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\JM\\Documents\\MyStatement.pdf";

    /*
    * retrieve a list of transactions within a date range given an account
    ...
    */
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate ) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankAddress = new PdfPCell(new Phrase("41 Runyani Ave, Roodepoort"));
